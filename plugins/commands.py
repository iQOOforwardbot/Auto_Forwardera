...
async def start(client, message):
    ...
    if Config.FORCE_SUB_ON:
        ...
        try:
            ...
            join_button = [
                [InlineKeyboardButton("Jᴏɪɴ Mʏ Uᴘᴅᴀᴛᴇ'S ᴄʜᴀɴɴᴇʟ✨", url=f"{Config.FORCE_SUB_CHANNEL}")],
                [InlineKeyboardButton("♻️ 𝐓ʀʏ 𝐀ɢᴀɪɴ", url=f"https://t.me/{client.username}?start=start")]
            ]
            await client.send_message(
                chat_id=message.chat.id,
                text="𝐒ᴏʀʀʏ 𝐘ᴏᴜ 𝐇𝐚𝐯𝐞 𝐍ᴏᴛ 𝐉ᴏɪɴᴇᴅ 𝐌ʏ 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐂ʜᴀɴɴᴇʟ, 𝐒ᴏ 𝐏ʟᴇᴀ𝐬ᴇ 𝐂ʟɪᴄᴋ 𝐎𝐧 𝐓𝐡𝐞 𝐉ᴏɪɴ 𝐁ᴜᴛᴛᴏɴ 𝐓ᴏ 𝐉ᴏɪɴ 𝐌ʏ 𝐂ʜᴀɴɴᴇʟ 𝐀ɴᴅ ♻️ 𝐓ʀʏ 𝐀ɢᴀɪɴ",
